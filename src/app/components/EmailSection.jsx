  ...
  return (
    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          This space is for your observations, suggestions, or ideas about my
          English.
        </p>
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          If you want to talk to me, you can send me a message. Your opinion is
          very important and it will help me to get better.
        </p>
